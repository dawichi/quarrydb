...
| [docker-sample-databases-plan.md](docker-sample-databases-plan.md) | "Try with Docker" sample database scoping — shared lifecycle/detection service plus per-provider sample configs |
